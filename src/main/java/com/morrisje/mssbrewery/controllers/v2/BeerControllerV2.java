package com.morrisje.mssbrewery.controllers.v2;


import com.morrisje.mssbrewery.services.v2.BeerServiceV2;
...
public class BeerControllerV2 {
    ...
    public  ResponseEntity handlePost(@RequestBody BeerDtoV2 beerDtoV2){
        ...
        headers.add("Location", "/api/v2/beer/" + saveDtoV2.getId().toString());
